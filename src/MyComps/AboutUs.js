...
import gif from "../MyComps/mygif.gif"
function MyAboutUs() {
  return (
    <section className="section about" id="about" aria-label="about">
      <div className="container">
        <div className="about-banner img-holder" style={{ "--width": "720px", "--height": "960px" }}>
          <img src={gif} width="720" height="960" loading="lazy" alt="about banner" className="img-cover" />
        ...
        <div className="about-content">
          ...
          <p className="section-text">
            Lorem ipsum dolor sit amet, consectetur adipiscing elit. In sagittis eg esta ante, sed viverra nunc tinci dunt nec elei fend et
            tiram.
          </p>
